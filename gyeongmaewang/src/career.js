...
homeHTML = function(){
  ...
  return `<div class="vn-title hub-hero kc-title">${vnBgHTML("bg_villa_night")}<div><h3 class="kc-logo">🏆 경 매 왕</h3><p class="kc-tag">싸게 사는 것만으로는 돈을 벌 수 없습니다.</p>
   ...
   <div class="hub-grid sm">
     ...
     <button type="button" class="panel hub-tile hub-prac" data-atab="chat"><span class="hub-thumb" style="background-image:url('${window.GMW_STANDALONE ? "assets/995ca7f6b064529126eccd0efe96a529.webp" : "/_blob/995ca7f6b064529126eccd0efe96a529"}')" aria-hidden="true"></span><span class="hub-ic">💬</span><b>협상 연습</b><small>AI 점유자·중개사와 대화</small></button>
     <button type="button" class="panel hub-tile hub-prac" data-atab="sell"><span class="hub-thumb" style="background-image:url('${window.GMW_STANDALONE ? "assets/4734bfef1b75ff19a4661b10c1ceadab.webp" : "/_blob/4734bfef1b75ff19a4661b10c1ceadab"}')" aria-hidden="true"></span><span class="hub-ic">🏷️</span><b>매도 연습</b><small>호가 정하기</small></button>
     <button type="button" class="panel hub-tile hub-prac" data-atab="guess"><span class="hub-thumb" style="background-image:url('${window.GMW_STANDALONE ? "assets/c387ea6e2f586a5994a9ee6f65cf4d9e.webp" : "/_blob/c387ea6e2f586a5994a9ee6f65cf4d9e"}')" aria-hidden="true"></span><span class="hub-ic">🎯</span><b>시세 맞히기</b><small>실제 과거 거래로</small></button></div>`;
};
function recHTML(){
