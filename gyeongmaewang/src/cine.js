...
const LF_PATHS = {
  seoyun:{q:"통장이 조금씩 불었다. 부모님은 \"이제 취업은?\" 하고 물으신다.", opts:[
    {id:"job", t:"취업한다", d:"월급 300만원이 생긴다. 대신 평일은 퇴근 후 저녁 4시간만", econ:E => ({inc:[300, 300], incT:"월급(신입)"}), window:(dow, w) => dow === 0 || dow === 6 ? [600, 280] : [1170, 130]},
