...
const EP_PLAN = {
  ...
  jaehoon:{stars:4, base:4800, hold:6, eps:[
    {k:"f41", name:"비 온 다음 날의 누런 선", sub:"침수 흔적 반지하", when:"1년차 · 봄", lines:["두 번 유찰된 반지하. 최저가가 감정가의 64%까지 내려왔다.","'봐라, 벽은 거짓말을 안 한다 아이가. 비 온 다음 날 가 보자.'"]},
  ...
  eunkyung:{stars:4, base:6800, hold:8, eps:[
    ...
    {k:"f53", name:"열람에 없는 6천만원", sub:"외국인 선순위 임차인", when:"2년차 · 봄", lines:["두 번 유찰, 최저가가 감정가의 절반 아래. 전입세대 열람엔 아무도 없다.","'다들 안 들어오는 데는 이유가 있어. 비고란까지 읽자.'"]},
