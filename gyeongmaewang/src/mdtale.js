...
const MT_TALES = {
 p_grandpa:[
  [[null,"할아버지가 현관 앞 계단에 털썩 앉는다. 담배를 꺼냈다가 도로 넣는다.","worried"],
   ["","내가 말이다, 이 집 들어올 때 부동산이 뭐라 캤는지 아나? '할아버지, 여기 주인 양반 좋은 사람이에요.' 그 말만 믿고 300 넣었다 아이가.","normal"],
   ["","현장 일이 그렇다. 비 오믄 공치고, 겨울엔 일이 없고. 그래도 월세 25만원은 한 번도 안 밀렸다. 통장 보여 주꼬?","normal"],
   ["","근데 어느 날 법원에서 누런 봉투가 오더니 경매라 카네. 나는 경매가 뭔지도 모른다. 주인 양반한테 전화하니까 없는 번호라 카고.","angry"],
   ["","그래서 동사무소 가서 물었더니 뭐, 배당? 나는 한 푼도 없다 카대. 들어온 날짜가 늦어서. 날짜 늦은 기 내 잘못이가?","angry"],
   ["","…아이다, 젊은 양반한테 화낼 일은 아인데. 미안하데이. 요새 내가 말이 곱게 안 나온다.","worried"]],
  [["할머니","(방 안에서) 여보, 누구 왔어요? 우리 철수 왔어?","normal"],
   ["","아이다, 손님이다. 들어가 있어라. …집사람이 요새 깜빡깜빡한다. 병원에선 초기라 카는데, 아들 이름을 하루에도 몇 번씩 부른다.","worried"],
   ["","아들놈은 부산 산다. 지 살기도 바쁘다. 이런 얘기 하믄 걱정만 하니까 안 했제.","worried"],
   ["할머니","(문틈으로) 손님 오셨는데 커피라도 드려야지. 설탕 넣어요?","normal"],
   ["","…저 사람한텐 이사 간다는 말을 몬 했다. 짐 싸는 거 보믄 불안해가 밤새 못 잔다 아이가. 익숙한 데서 떠나믄 더 헤맨다 카더라.","worried"],
   ["","그러니까 내 말은, 나가긴 나가야제. 근데 한 달은 줘야 된다. 방도 구하고, 저 사람한테 천천히 말할 시간.","normal"]],
  [["","방은 알아봤다. 반지하 하나 있는데 보증금이 모자란다. 150만 있으믄 된다.","normal"],
   ["","동사무소에서 주거급여 얘기는 들었다. 근데 서류가 한 보따리라. 내 같은 사람은 그런 거 쓸 줄을 모른다.","worried"],
   ["","…고맙다는 말은 해야겠네. 여기 온 사람들 다 문 두드리고 '언제 나가요'만 했제, 이래 앉아서 들어 준 사람은 없었다.","normal"],
