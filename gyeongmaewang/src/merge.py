...
a = s.index('\nconst CASES = [')
b = s.index('\nrender();\n</script>')
s = s[:a] + '\n' + cases + '\n' + open('scenes.js').read() + '\n' + open('caseui.js').read() + '\n' + open('caseart.js').read() + '\n' + open('avatar.js').read() + '\n' + open('portrait.js').read() + '\n' + open('villacalc.js').read() + '\n' + open('arena.js').read() + '\n' + open('fun.js').read() + '\n' + open('scenario_sample01.js').read() + '\n' + open('sellgame.js').read() + '\n' + open('guessgame.js').read() + '\n' + open('art.js').read() + '\n' + open('vnstage.js').read() + '\n' + open('growth.js').read() + '\n' + open('kingrun.js').read() + '\n' + open('story.js').read() + '\n' + open('story2.js').read() + '\n' + open('hub.js').read() + '\n' + open('career.js').read() + '\n' + open('feel.js').read() + '\n' + open('case002.js').read() + '\n' + open('research.js').read() + '\n' + open('polish2.js').read() + '\n' + open('week.js').read() + '\n' + open('sense.js').read() + '\n' + open('life.js').read() + '\n' + open('cine.js').read() + '\n' + open('charart.js').read() + '\n' + open('stage.js').read() + '\n' + open('sheetart.js').read() + '\n' + open('qa1.js').read() + '\n' + open('campaign.js').read() + '\n' + open('polish.js').read() + '\n' + open('deep.js').read() + '\n' + open('mdtale.js').read() + '\n' + open('layout.js').read() + '\n' + open('noscroll.js').read() + '\n' + open('firstrun.js').read() + '\n' + open('sturdy.js').read() + '\n' + open('sidefold.js').read() + '\n' + open('lostflow.js').read() + '\n' + open('npcface.js').read() + '\n' + open('roomhub.js').read() + '\n' + open('charvoice.js').read() + '\n' + open('rivalface.js').read() + '\n' + open('buyerface.js').read() + '\n' + open('newocc.js').read() + '\n' + open('clueflash.js').read() + '\n' + open('fullcase.js').read() + '\n' + open('episode.js').read() + '\n' + open('loan.js').read() + '\n' + open('saleterms.js').read() + '\n' + open('moveblock.js').read() + '\n' + open('resume.js').read() + '\n' + open('readfast.js').read() + '\n' + open('charabil.js').read() + '\n' + open('evidence.js').read() + '\n' + open('bidwarn.js').read() + '\n' + open('credit.js').read() + '\n' + open('artslots_data.js').read() + '\n' + open('artslots.js').read() + '\n' + open('interlude.js').read() + '\n' + ''.join(open(f).read() + '\n' for f in sorted(__import__('glob').glob('il_[A-Z]*.js'))) + open('il_proxy.js').read() + '\n' + open('stgmid.js').read() + '\n' + open('npcbub.js').read() + '\n' + open('realbid.js').read() + '\n' + open('bgmvar.js').read() + '\n' + open('dayboard.js').read() + '\n' + open('salefolks.js').read() + '\n' + open('dohyunproxy.js').read() + '\n' + open('amb.js').read() + '\n' + open('taletalk.js').read() + '\n' + open('surprise.js').read() + '\n' + open('hidden.js').read() + '\n' + open('easy.js').read() + '\n' + ''.join(open(f).read() + '\n' for f in sorted(__import__('glob').glob('oe_*.js'))) + open('story_oe.js').read() + s[b:]
# ---- css (case deep + arena)
...
rep(old, new)
rep('family=IBM+Plex+Mono:wght@500&display=swap', 'family=IBM+Plex+Mono:wght@500&family=Do+Hyeon&family=Black+Han+Sans&display=swap')
