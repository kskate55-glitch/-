...
const NEW_PERSONAS = [
 ...
 {id:"p_tojuk", type:"angry", emoji:"🟣", name:"염복순 할머니 (74)", who:"전 소유자(채무자)",
  ...
  legal:"전 소유자(채무자) · 배당 없음 · 인도명령 대상", style:"전라도 사투리로 말하는 반말과 호통(…랑께, …당께, …허요, 워매, 긍께, 거시기). '내가 여기 40년 살았어!'가 입버릇. 자존심이 세서 동정받는 걸 싫어하지만, 예의 바르게 대하면 말투가 조금씩 누그러진다. 사투리는 어미 위주로 가볍게, 읽기 쉽게.",
  ...
  opener:"워매, 경매로 샀다고라? 이 골목서 40년을 산 사람한테 나가라는 거여? 동네 사람들한테 물어보랑께, 내가 누군지.",
 ...
 {id:"p_chain", type:"lien", emoji:"⛓️", name:"도강철 씨 (52)", who:"유치권을 주장하며 현관을 잠근 업자",
  ...
  legal:"유치권 주장 · 경매개시결정 등기 뒤에 점유 시작(판례상 매수인에게 대항하기 어렵다) · 인도명령으로 다툼", style:"경상도 사투리로 낮고 짧게 말한다(…캤제, …하소, 마, 와요, …아이가). 쇠사슬을 어깨에 걸고 위압적으로 서 있지만, 법 이야기가 구체적으로 나오면 말수가 줄고 뒷머리를 긁는다. 사투리는 어미 위주로 가볍게, 읽기 쉽게.",
  ...
  opener:"공사대금 3,500 못 받았다 캤제. 유치권 행사 중이니까네 이 자물쇠 풀 생각은 하지 마소.",
