...
KP1.actions = [
  ...
  {id:"occ",    loc:"site", ic:"🚪", t:"점유자 접촉 시도", dur:[30,120], iv:5, rel:3, risk:4, d:"정보는 크지만 관계가 틀어질 수 있음",
    out:[{p:0.45, reveal:"flip", say:["최만식 할아버지","…딸한테 물어봐야 된다. 내는 모르겠다."], occ:-6}], base:{say:["최만식 할아버지","(문 너머) 누구요? 낙찰도 안 됐는데 와 왔노!"], occ:-12}},
...
KP2.actions = [
  ...
  {id:"kim",    loc:"any",  ic:"📞", t:"단골 중개사 김사장에게 전화", dur:15, iv:1, rel:1, d:"빠르지만 허풍일 수 있음", base:{say:["김사장","1억 7천은 무조건 되쥬. 요즘 투룸 없어서 난리여유."], useful:true}},
  {id:"call3",  loc:"any",  ic:"☎️", t:"중개사 3곳 전화 돌리기", dur:45, iv:3, rel:3,
