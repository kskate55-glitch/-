...
for t in t69 t68 t67 t66 t65 t64 t63 t62 t52 t55 t57 t58e t56 t59 t61 t41 t43 t33 t40 t48 t50 t51 t54 t45 t49; do echo "== $t" >> $OUT; NODE_PATH=$(npm root -g) timeout 500 node $t.js 2>&1 | grep -E "❌|errors|Error|clicks|bad \[" | head -8 >> $OUT; done
