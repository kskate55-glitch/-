...
await p.click('[data-kres="docs"]'); await p.fill('#kBid','12650'); await p.click('[data-kcseal]'); await p.waitForTimeout(300); await p.click('[data-kbid]'); await p.waitForTimeout(9000);
