...
// 서윤 오프닝 전용 그림 3장
const o=await p.evaluate(async()=>{ const ks=['op_seoyun_1','op_seoyun_1_2','op_seoyun_2_3','op_seoyun_3','op_dohyun_1','op_dohyun_1_2']; const us=ks.map(k=>artUrl(k));
...
ok(o.all && o.distinct===6, '오프닝 6장(서윤 4·도현 2)이 로드됨');
