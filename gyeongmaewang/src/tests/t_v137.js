...
ok(g13.f52==='bg_case_f52_ext,bg_case_f52_door,bg_case_f52_in' && g13.f53==='bg_case_f53_ext,bg_case_f53_door,bg_room_empty', 'f52 3장 · f53 외관·현관 전용');
const l13=await p.evaluate(async()=>Promise.all(['f51_in','f52_ext','f52_door','f52_in','f53_ext','f53_door'].map(k=>new Promise(r=>{ const i=new Image(); i.onload=()=>r(i.naturalWidth>1000); i.onerror=()=>r(false); i.src=artUrl('bg_case_'+k); }))));
