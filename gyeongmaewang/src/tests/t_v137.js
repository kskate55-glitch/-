...
// 서윤 오프닝 전용 그림 3장
const o=await p.evaluate(async()=>{ const ks=['op_seoyun_1','op_seoyun_1_2','op_seoyun_2_3','op_seoyun_3','op_dohyun_1','op_dohyun_1_2','op_dohyun_2','op_dohyun_3','op_dohyun_3_2']; const us=ks.map(k=>artUrl(k));
  ...
  return {all:loads.every(Boolean), distinct:new Set(us).size, other:!!artRec()['op_mijeong_1'] || (ART_DEFAULT['op_mijeong_1']||null)}; });
ok(o.all && o.distinct===9, '오프닝 9장(서윤 4·도현 5)이 로드됨');
