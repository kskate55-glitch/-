...
// 서윤 오프닝 전용 그림 3장
const o=await p.evaluate(async()=>{ const ks=['op_seoyun_1','op_seoyun_1_2','op_seoyun_2_3','op_seoyun_3','op_dohyun_1','op_dohyun_1_2','op_dohyun_2','op_dohyun_3','op_dohyun_3_2','op_dohyun_4','op_dohyun_5','op_dohyun_5_2','op_mijeong_1','op_mijeong_2','op_mijeong_2_3']; const us=ks.map(k=>artUrl(k));
...
ok(o.all && o.distinct===15, '오프닝 15장(서윤 4·도현 8·미정 3)이 로드됨');
