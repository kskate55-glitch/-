...
ok(['cg_il_s01_a','cg_il_s01_b','cg_il_s01_c','cg_il_d01_a','cg_il_d01_b','cg_il_s03_c','cg_il_d01_c','cg_il_d03_a','cg_il_s03_a','cg_il_s03_b','cg_il_m01_a','cg_il_m01_b','cg_il_m01_c','cg_il_d03_c','cg_il_d03_b','cg_il_m03_a','cg_il_m03_b','cg_il_m03_c','cg_il_j01_a','cg_il_j01_b'].every(c=>list.some(x=>x.cg===c)), '장면 그림 등록 ('+list.length+'칸)');
for(const x of list){
