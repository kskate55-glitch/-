...
const r=await p.evaluate(async()=>{ const imgs=[...document.querySelectorAll('img')].filter(i=>/1c6b3dce|f9a54944|7ce522d0|a25aee10|8411f75d|fcf378d2|98c781ac|5f19cdba|05db0607|1f3f7d1a|78650e51|67d15b12/.test(i.src)||/1c6b3dce|f9a54944|7ce522d0|a25aee10|8411f75d|fcf378d2|98c781ac|5f19cdba|05db0607|1f3f7d1a|78650e51|67d15b12/.test(i.currentSrc)); const bgs=[...document.querySelectorAll('[style*="background-image"]')].filter(e=>/1c6b3dce|f9a54944|7ce522d0|a25aee10|8411f75d|fcf378d2|98c781ac|5f19cdba|05db0607|1f3f7d1a|78650e51|67d15b12/.test(e.style.backgroundImage)); for(const i of imgs){ i.loading='eager'; await new Promise(r=>{ if(i.complete&&i.naturalWidth) r(); i.onload=r; i.onerror=r; setTimeout(r,3000);}); } return {img:imgs.map(i=>i.naturalWidth), bg:bgs.length}; });
