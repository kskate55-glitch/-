...
PREDICTION_INTERVAL_SAMPLE_N = {0: 37, 1: 61, 2: 47}
...
def compute_estimate_warnings(filtered: list[dict],
    ...
    #    실측(경기 44건): 0건 14.5% · 1건 18.9% · 2~3건 11.0% · 4건 이상 3.1%.
    #    재실측(92건): 0건 11.7% · 1건 14.6% · 2~3건 8.4% · 4건 이상 7.8%
    #    — **다른 표본에서도 1건이 0건보다 나쁘다는 순서가 그대로 나왔다.**
